                            ...
                            @foreach ($data as $row)
                                <tr>
                                    ...
                                    <td><img src="img/GearPT/{{ $row->clientImage }}" width="100px" height="100px"
                                            alt=""></td>
                                    <td>
                                        <a href="{{ url('edit-client/' . $row->clientID) }}"
                                            class="btn btn-primary">Edit</a>
                                        <a href="{{ url('delete-client/' . $row->clientID) }}" class="btn btn-danger"
                                            onclick="return confirm('Are you sure to Delete this client')">Delete</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
