        ...
        <div class="content-wrapper">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div>
                        <a href="{{ url('add-orderdetail') }}" class="btn btn-dark"
                        ...
                        <tbody>
                            @foreach ($data as $row)
                                <tr>
                                    ...
                                    <td>{{ $row->productID }}</td>
                                    <td>
                                        <a href="{{ url('edit-orderdetail/' . $row->orderDetailID) }}"
                                            class="btn btn-primary">Edit</a>
                                        <a href="{{ url('delete-orderdetail/' . $row->orderDetailID) }}"
                                            class="btn btn-danger"
                                            onclick="return confirm('Are you sure to Delete this order detail')">Delete</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
