	...
	<body>
		...
		<div class="section">
			...
			<div class="container">
                ...
                <!-- /row -->
                <div style="text-align:right" class="store-pagination">
                    {{ $products->links() }}
                </div>
                @endif
			</div>
				...
				<div class="row">
					<div class="col-md-12">
						<ul class="breadcrumb-tree">
							...
							<li class="active"><a href="{{url('product')}}"></a> Product</li>
						</ul>
					</div>
				</div>
				<!-- /row -->
								...
								@foreach ( $products as $row )
									...
									<a href="productDetail/{{$row->productID}}">
										...
										<div class="col-md-3">
											<div class="product">
												<div class="product-img">
													<img src="img/GearPT/{{$row->productImage}}" height="2	00" width="300" alt="">
												</div>
												<div class="product-body">
													<p class="product-category">{{$row->productTypeName}}</p>
													<h3 class="product-name"><a href="#">{{$row->productName}}</a></h3>
