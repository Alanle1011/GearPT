...
<head>
    ...
    <title>Order Detail Addition Page</title>
</head>
<body>
    <div class="container mt-3" >
        <h2>Order Detail Addition</h2>
        @if(Session::has('success'))
        <div class="alert alert-success" role="alert">
            {{Session::get('success')}}
        </div>
        @endif
        <form action="{{url('save-orderdetail')}}" method="post" enctype="multipart/form-data" style="margin: 50px">
            @csrf
            ...
            <button type="submit" class="btn btn-primary" onclick="return confirm('Are you sure to ADD this orderdetail')">Add</button>
