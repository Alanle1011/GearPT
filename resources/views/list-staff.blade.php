    ...
    <div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true"
        ...
        <div class="main-menu-content">
            ...
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class="active-toggle"><a href="{{ url('piezchart') }}"><i class="la la-pie-chart"></i><span
        ...
        <div class="content-wrapper">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div>
                        <a href="{{ url('add-staff') }}" class="btn btn-dark"
                        ...
                        <tbody>
                            @foreach ($data as $row)
                                <tr>
                                    ...
                                    <td><img src="img/GearPT/{{ $row->staffImage }}" width="100px" height="100px"
                                            alt=""></td>
                                    <td>
                                        <a href="{{ url('edit-staff/' . $row->staffID) }}"
                                            class="btn btn-primary">Edit</a>
                                        <a href="{{ url('delete-staff/' . $row->staffID) }}" class="btn btn-danger"
